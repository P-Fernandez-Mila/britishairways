...
interface Trip {
  ...
  interface Passenger {
    firstName: string;
    lastName: string;
    passengerType: 'ADT' | 'CHD' | 'INF'; // Assuming these are the possible types: Adult, Child, Infant
  }
  ...
  interface ItineraryItem {
    ...
    arrivalTime: string; // ISO 8601 format date-time string
    flightNumber: string;
    airlineCode: string;
    class: 'Economy' | 'Business' | 'First'; // Assuming these are the possible classes
  }
